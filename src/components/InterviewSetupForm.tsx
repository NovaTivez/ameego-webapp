    ...
    >
      ...
      {value.interviewType === "custom" ? (
        <div className="interview-field">
          ...
          {errors.customInterviewType ? (
            <span className="field-error">{errors.customInterviewType}</span>
          ) : null}
        </div>
      ) : null}
      ...
      <div className="interview-field-grid">
        ...
        <div className="interview-field">
          ...
          />
          {errors.organization ? (
            <span className="field-error">{errors.organization}</span>
          ) : null}
        </div>
      </div>
      ...
      <div className="interview-field">
        ...
        />
        {errors.goals ? <span className="field-error">{errors.goals}</span> : null}
      </div>
